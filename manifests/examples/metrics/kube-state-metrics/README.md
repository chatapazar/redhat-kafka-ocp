...
This folder contains examples of how Streams for Apache Kafka integrates [kube-state-metrics](https://github.com/kubernetes/kube-state-metrics) (KSM) for custom resources monitoring and demonstrates how they can be used.
